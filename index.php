...
// DIRECTOR SIGNATURE
$route->router("/signature", "src/Controller/directorSignatureController.php");
$route->router("/signature/{action}", "src/Controller/directorSignatureController.php");
$route->router("/signature/{action}/{id}", "src/Controller/directorSignatureController.php");

// ASSETS SUPPLIER OR DONOR
...
$route->router("/migration/{school_code}/{page}", "src/Controller/migrationController.php");

// DELIVERY NOTE
$route->router("/download_delivery_note", "src/Controller/deliveryNoteController.php");
$route->router("/download_delivery_note/{action}", "src/Controller/deliveryNoteController.php");

// ASSETS SCHOOL REQUEST
