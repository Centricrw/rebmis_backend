...
class elearningEnrollmentController
{
    ...
    private function enrolToCourse($course_Id, $staff_code)
    {
        ...
        try {
            $link = 'https://elearning.reb.rw/sandbox/local/custom_services/userregister.php?firstname='.$firstname.'&lastname='.$lastname.'&username='.$username.'&email='.$email.'&password='.$password.'';
