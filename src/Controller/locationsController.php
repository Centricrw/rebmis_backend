...
class locationsController
{
        ...
        switch ($this->request_method) {
            ...
            case 'GET':
                if (sizeof($this->params) > 0) {
                    ...
                    if ($this->params['action'] == "schools") {
                        $response = $this->getAllSchools();
                    }
                    if ($this->params['action'] == "levels") {
                        $response = $this->getAllLevels();
                    }
                }
                break;
            default:
    ...
    {
        $result = $this->locationsModel->getAllschool();
    ...
    {
        $result = $this->locationsModel->getAllLevels();
