...
class CohortconditionModel
{
    ...
    {
        if (isset($userDistrictCode) && $userDistrictCode !== "") {
            $statement = "SELECT T.*, S.school_name, SL.sector_name, SL.district_name, UR.role_id, UR.qualification_id, UR.position_code, UR.status, U.staff_code, U.email FROM trainees T
